...
import imgurl from '../assets/imagelist1.jpg'
// 滑入效果試著放在components
// import Aos from "aos";
...
export default function Home() {
  ...
  return (
    ...
    <div className='wrap'>
      <div><Navbar />
        <button className='d-none' onClick={loginOrNot}></button>
        ...
        <div className='container-xxl'>
          ...
          <div className='row'>
            <div className='col'>
              ...
              <div className='RoomList d-none d-xl-block' data-aos="fade-up">
                <Link to="/hotelIntro">
                  <QuiltedImageList />
                </Link>
              </div>
              ...
              <div className='col'>
                ...
                <div className='FeedBackFlex'>
                  ...
                  <div className='FeedBackLeft'>
                    ...
                    <div className='FeedBackRight d-flex justify-content-center' data-aos="fade-up" style={{ marginTop: '100px ' }} >
